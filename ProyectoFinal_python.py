...
response_caso = control.forced_response(sys1, t, u1)
salida_caso = response_caso[1]  # Salida del sistema para el Caso

# Respuesta del sistema para "Control"
response_control = control.forced_response(sys2, t, u1)
...
plt.title('Sistema Urinario con Caída y Regreso', fontsize=14)
plt.legend(loc='best', fontsize=10)

# Guardar la gráfica como imagen
plt.savefig('sistema_urinario_caida_regreso.png', dpi=300, bbox_inches='tight')
plt.show()
