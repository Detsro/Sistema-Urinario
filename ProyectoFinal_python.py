# -*- coding: utf-8 -*-
"""
Created on Wed Dec 18 10:46:34 2024
...
t0, tF, dt = 0, 20, 1E-2  # Configuración del tiempo inicial, final y el paso
N = round((tF - t0) / dt) + 1
...
plt.xticks(np.arange(0, 21, 2))  # Ajustar los ticks del eje X para que vayan de 2 en 2
plt.xlim(0, 20)
plt.ylim(0, 1)  # Ajustar los límites del eje Y para reflejar mejor las curvas
